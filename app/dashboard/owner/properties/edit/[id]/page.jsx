...
export default function EditPropertyPage() {
  ...
  useEffect(() => {
    const fetchProperty = async () => {
      try {
        ...
        setFormData(data);
        setPreviewImages(data.images.map(() => null)); 
        setIsLoading(false);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.images.length < 3) {
      setError('Veuillez garder au moins 3 photos');
      return;
    }
    ...
    try {
      ...
      setError(err.message || 'Erreur lors de la mise à jour du bien');
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Modifier le bien</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center">
                ...
                />
                <span className="ml-2 text-sm text-gray-700">Publier ce bien</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1 mb-6">
            ...
            <p className="text-xs text-gray-500 mb-2">Maintenez au moins 3 photos (max 10)</p>
